...
RUN mvn org.apache.maven.plugins:maven-dependency-plugin:3.3.0:get -Dartifact=org.apache.maven.plugins:maven-surefire-plugin:3.0.0
...
RUN mvn org.apache.maven.plugins:maven-dependency-plugin:3.3.0:get -Dartifact=org.apache.maven.surefire:surefire-junit-platform:3.0.0
